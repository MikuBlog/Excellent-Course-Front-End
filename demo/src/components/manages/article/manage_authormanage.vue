<template>
    ...
    <div id="manage-authormanage">

        <div class="manage-authormanage-box">
            <table v-if="!correct">
                <tr>
                    <th>作者名称</th>
                    <th>操作</th>
                </tr>
                <tr v-for="item in storageAuthorList">
                    <td>
                        {{item.name}}
                    </td>
                    <td>
                        <i class="fa fa-pencil fa-lg" @click="correctAuthor(item.name,item.id)"></i>
                        <i class="fa fa-trash fa-lg" @click="throwAuthor(item.id)"></i>
                    </td>
                </tr>
            </table>
            ...
            <div class="info-right-next" v-if="!correct">
                ...
                <span v-for="number in total" @click="getAuthorList(number)" class="info-right-span">{{number}}</span>
            ...
            <div class="manage-authormanage-box-correct" v-if="correct">
                <form>
                    <div>
        ...
        <div class="manage-authormanage-message" v-if="showMessage">
            <div class="manage-authormanage-message-box">
                <div class="content">
                    缩略图名称: {{thumbName}}
                </div>
                <div class="content">
        ...
        methods: {
            ...
            throwAuthor(id) {
                ...
                $.ajax({
                    ...
                    url:"http://qwebfx-test.deali.cn/api/post/author/delete",
                    ...
                    success(data) {
                        ...
                        _this.getAuthorList(_this.nowPageNumber)
            ...
            goTail() {
                ...
                this.getAuthorList(this.pageNumber)
            ...
            next(command) {
                ...
                if(command == "next") {
                    ...
                    this.getAuthorList(++this.nowPageNumber)
            ...
            getTotal() {
                ...
                $.ajax({
                    ...
                    url:"http://qwebfx-test.deali.cn/api/post/author/count",
            ...
            sendMessage() {
                ...
                $.ajax({
                    ...
                    url:"http://qwebfx-test.deali.cn/api/post/author/update",
            ...
            initialAuthorList(list) {
                ...
                this.storageAuthorList.length = 0
...
<style lang="scss">
    ...
    #manage-authormanage {
        ...
        .manage-authormanage-box {
            ...
            .manage-authormanage-box-correct {
                position: relative;
                background: white;
                box-shadow: 0 0 1px 1px rgb(240, 240, 240);
                height:20rem;
        ...
        .manage-authormanage-message {
            ...
            .manage-authormanage-message-box {
                position: absolute;
                top:0;
                right:0;
                left:0;
