<template>
    ...
    <div id="manage-videoadd">

        <div class="manage-videoadd-box">

            <div class="manage-videoadd-box-correct">
                <form>
                    <div>
        ...
        methods: {
            ...
            sendMessage() {
                ...
                $.ajax({
                    ...
                    url:"http://qwebfx-test.deali.cn/api/video/add",
